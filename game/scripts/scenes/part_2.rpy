...
label sylvian_route:
    ...
    show sylvian with dissolve
    show lars
    Lars "Perhaps Zephyr should have taken up the role of the prime content for his beloved gossip column with all the antics he's pulling."

    show lars
    Lars "Exploiting the humans' unfamiliarity with Div customs and culture would certainly add a mysterious twist for everyone once they learn what's been happening under their noses."
    ...
    Lars narration "Master Sylvian's hands glide with practiced grace, weaving a spell that summons blossoms, enveloping him in an ethereal aura."
    ...
    show sylvian_cloudy with dissolve
    ...
    hide sylvian_cloudy with dissolve
    show sylvian sad at center 
    with dissolve

    Lars narration "Speaking of excitement, it's probably best to keep my tail perfectly still. As for my fox ears, I delicately adjust them, trying to maintain an appearance of composure."

    Lars narration "The subtle flicker of my ears betrays the underlying nervousness of being in the presence of my Master's watchful gaze."
...
label S3_sylvian_bad_end:
    ...
    Lars narration "Seems like we're in quite an awkward situation..."
    ...
    Lars "But before he has the chance to grumble any further, I swiftly move to the spot where Spotsy is resting. Smoothly climbing onto her back, I feel the afternoon air gently bristling against my fur."
    ...
    Lars narration "I observe his back shrinking even more, but as I sit on Spotsy's back, no response comes my way."
    ...
    show lars serious
    Lars "I was worried for you! You know how I felt, suddenly seeing you fly off like that in the middle of our talk?! Even that ghost-faced Zephyr got scared of what you were doing." with vpunch
    ...
    Lars narration "That peculiar expression resurfaces once more, akin to an awkward smile concealing a laugh meant solely for his own amusement."
    ...
    Sylvian "No need to worry. The Archmage will have silenced him long before any reputable gossip columns consider his story. He doesn't tolerate his academics engaging in such...{i}activities{/i}."
...
label S3_sylvian_good_end:
    ...
    voice "audio/voice/lars/lars_136_take02.ogg"
    Lars "What is?"
    ...
    Sylvian "I-I made that our guild motto while thinking of someone who I had yet to meet."
    ...
    if options["CS3"]==1:
        ...
        show sylvian
        Sylvian "Perhaps you've already picked on some of my clues."
    ...
    show sylvian
    Lars narration "An awkward silence envelops the air. Even someone as clueless as Zephyr turns back to look at us and see what's going on. But before he has the chance to say anything, A sigh escapes Master Sylvian as he slowly shakes his head, lifting his gaze to the expanse of the stars."
    ...
    voice "audio/voice/sylvian/sylvian_131_take02.ogg"
    Sylvian "That's a unique way to phrase it indeed."

    voice "audio/voice/lars/lars_154_take02.ogg"
    show lars serious
    ...
    show sylvian blush
    Sylvian "{sc}Hahahaha!{/sc}, [Lars], what would I do without you..."
...
label C3_claude_good_end:
    ...
    if options["CS3"]==1:
        ...
        voice "audio/voice/lars/lars_172_take02.ogg"
        show lars serious
    ...
    if options["CS3"]==2:
        ...
        voice "audio/voice/lars/lars_173_take02.ogg"
        show lars blush
        ...
        voice "audio/voice/lars/lars_174_take01.ogg"
        show lars
        Lars "Well, yes, you're right. My parents would always tell me to be direct with my words, as dragons can have trouble reading your intentions if you're not straightforward or heartfelt in your interactions. So, it would be best to just say what's on your mind. But then again, you're not a dragon—"

        voice "audio/voice/lars/lars_176_take02.ogg"
        show lars sad
    ...
    voice "audio/voice/lars/lars_177_take01.ogg"
    ...
    voice "audio/voice/lars/lars_179_take01.ogg"
    ...
    Lars narration "I never expected to be {i}this{/i} affected by his flirtations, but the sincerity in his voice is stirring something within me. My heart is pounding in a way I didn't see coming."
    ...
    Claude "Anyway, they've got it all figured out, I'm sure. Now, how about indulging me with a few more kisses?"
