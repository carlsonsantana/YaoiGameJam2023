...
label playfully_surprise_him:
    ...
    voice "audio/voice/lars_003_take02.ogg"
...
label resist_the_urge_to_surprise_him:
    ...
    voice "audio/voice/lars_007_take02.ogg"
    show lars
    ...
    voice "audio/voice/lars_008_take02.ogg"
    show lars serious
...
label C_1_End:
    ...
    voice "audio/voice/lars_009_take01.ogg"
    show lars
    ...
    voice "audio/voice/lars_010_take01.ogg"
    show lars serious
    Lars "Do we have to go over this cliche back and forth as well?"

    voice "audio/voice/lars_011_take02.ogg"
    show lars serious
    ...
    voice "audio/voice/lars_012_take01.ogg"
    show lars serious
    ...
    voice "audio/voice/lars_013_take02.ogg"
    show lars
    show claude smile with dissolve
    ...
    show spotsy
    with dissolve
    Lars "I reach out, my hand confidently caressing the head of our newest guild member who I hope I’m taking good care of."

    Lars  "Her eyes meet mine in and in a show of trust, her scale’s part open, revealing mesmerizing roseate flames simmering underneath."

    show lars
    Claude "Don’t let your attention wander off too much, Captain."

    Lars "Sir Claude's voice carries a subtle touch of displeasure as he observes me caressing Spotsy's head."

    Lars "Maybe the uncomfortable seating arrangement is getting to him."
    ...
    voice "audio/voice/lars_014_take01.ogg"
    show lars serious
    ...
    voice "audio/voice/lars_015_take02.ogg"
    show claude smile with dissolve
    show lars serious
    ...
    with dissolve
    show lars
    Claude "Your sarcasm is showing Captain, might want to hide it under a thin layer of worry or, Divs forbid, {i}concern{/i} for your partner."
...
label apologize_for_teasing_him:
    ...
    show claude smile with dissolve 
    show lars
    Claude "There’s something that I {i}really{/i} want but with our relationship as is, you won’t be able to give it to me."
...
label C_2_End:
    ...
    show lars
    "{color=#026C45}Unknown" "Welcome back, dear members of {i}Custodes Sylvae{/i}. I’m happy to see that you both landed safely."
...
label ask_Sylvian_grab_cargo:
    ...
    show rory at jp
    show lars happy
    Rory "[Lars], you’re here too. It's so {i}pawsitively fantastic{/i} to see you!"

    show lars happy
    Claude "Well, last time {i}I{/i} checked, Captain was  showcasing fingers so refined, they {i}redefined{/i} fantastic. But hey, who am I to burst your bubble, little—"

    show lars happy
    Rory "Awe, I missed you so much! I was starting to hallucinate some {i}unsavory{/i} voices."
...
label poke_further_and_ask:
    ...
    show lars
    Sylvian "Hahahaha! Haha…" with vpunch
...
label sir_Claude:
    ...
    show rory at center_left with dissolve
    show sylvian at right with dissolve
...
label ask_Master_Sylvian_about:
    ...
    show lars narration
    Lars "Understood, Master. I’m not sure I get it entirely, but I won’t press you further, especially since I’m in doubt if you’re referring to a personal secret or something {i}more{/i}."
...
label ask_Sir_Claude_about:
    ...
    show lars
    Lars "His presents are purely gestures of appreciation, but rings usually mean a lot more."

    Lars "Proposals, offerings, significant others…what would my passengers think—"
    ...
    show lars narration
    Lars "No rings! I don’t want to be burdened with uncertain feelings."

    show lars narration
    Lars "I won’t let myself be strung along especially since I need to keep my mind sharp for the passengers. What would happen if I were to be distracted and something happened to them? What if—"
...
label look_back_at_Master_Sylvian:
    ...
    show lars serious
    Sylvian "{size=*1.25}THAT’S ENOUGH CLAUDE!" with vpunch

    show lars serious
    Sylvian "I treasure you as a guild member of {i}'Custodes Sylvae'{/i}, but your snapdragon of a mouth is intolerable."
...
label look_back_at_Sir_Claude:
    ...
    show lars sad
    Lars "{size=*0.75}But why is he looking at me like that?{/size}"
...
label CS_4_End:
    ...
    show claude smile
    Claude "You think you’re so fast, huh? I could leave you speechless If I wanted."
    ...
    show claude serious at center_2left
    show sylvian sad at center_1right
    with dissolve
...
label agree_with_Master_Sylvian:
    ...
    show lars
    Sylvian "Phew, thankfully, Claude’s influence hasn’t rubbed on you too much."

    show sylvian blush with dissolve
    show lars
    Sylvian "I’m always impressed by how well you articulate your words, my dear junior. Perhaps we can delve into these philosophies and {i}other matters{/i} when we find some time for ourselves later."
...
label CS_5_End:
    ...
    show lars serious
    "{color=#CD4EDD}Unknown" "Looks like some {i}interesting{/i} Divs have entered my domain while I was occupied."
    ...
    "{color=#CD4EDD}Unknown" "I was frozen in anticipation for what would come next, but I have work to do after this. My castle isn’t going to clean up after itself!"

    show zephyr happy at jp
    "{color=#CD4EDD}Unknown" "Get it? {i}frozen in anticipation{/i}. {bt}Hehehehehe~{/bt}"
    ...
    "{color=#CD4EDD}Unknown" "Slow doooown there."

    "{color=#CD4EDD}Unknown" "Times not running away after all. You know?"
    ...
    "{color=#CD4EDD}Unknown" "DON’T JUDGE ME!"
    ...
    "{color=#CD4EDD}Unknown" "Ah, the inquisitive one speaks. Hmm, I’ll call you Scouty from now on since you look the part as well."

    Lars "My name is [Lars], not Scouty!"

    "{color=#CD4EDD}Unknown" "My brain cells will only acknowledge you as Scouty from here on out."

    "{color=#CD4EDD}Unknown" "You're all destined to be new additions to my castle renovation army, so sparing the effort of using two names at once seems reasonable."

    show lars
    Lars "But you only have to remember one, which is {i}[Lars]{/i}—"

    "{color=#CD4EDD}Unknown" "Well, let's see who else we have in this riveting cohort. I'm sure your names are all yawn-inducing, but let's make this roll call fun, shall we?"

    "{color=#CD4EDD}Unknown" "You, the one with the flowery hat, must be the smart one in the group since you haven’t interrupted me so far. I’ll call you Smarty from now on."

    "{color=#CD4EDD}Unknown" "But be careful not to interject too much like Scouty."
    ...
    "{color=#CD4EDD}Unknown" "Scouty, and the other two, I need my main character moment over here, stop blabbering so much."
    ...
    show lars serious
    "{color=#CD4EDD}Unknown" "As I was saying—"
    ...
    "{color=#CD4EDD}Unknown" "Impressive words, especially considering your current disadvantage but I’ll humor you this time."

    "{color=#CD4EDD}Unknown" "Since Smarty asked, it’s time for the cliché introduction séance, the kind they do for video games and TV shows."

    "{color=#CD4EDD}Unknown" "Hopefully, they spared no expense in making me the fairest of them all. A little extra villainous charm never hurt anyone~"

    "{color=#CD4EDD}Unknown" "But before that, you’d better cease all your magical theatrics and weapon brandishing if you don't want me to lose interest in this little charade."
    ...
    show sylvian at center_right
    show claude at center_left
    "{color=#CD4EDD}Unknown" "Anyway, you can address me as the “Omniscient Lord of Bankruptcy” or if it’s easier on the tongue, the “Malevolent Architect of Debt”. Personally, I'm partial to the latter title—it aligns better with my aspirations."
...
label menu_g1:
    ...
    menu:
        " " " "
        "{size=*0.75}Are you the person responsible for freezing everyone?{/size}" if choice_g1[0]==0:
            $ options["G1"]=1
            $ choice_g1[0] = 1
            jump are_you_the_person

        "{size=*0.75}How come you’re freezing everyone for a castle renovation?{/size}" if choice_g1[1]==0:
            $ options["G1"]=2
            $ choice_g1[1] = 1
            jump how_come_you
