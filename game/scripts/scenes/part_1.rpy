label part_1:
    ...
    "{i}Discere, cogitare, agere— {/i}the triad of wisdom."

    "\'Learning enriches the mind, and thinking sharpens it, but it is through action that we truly manifest our knowledge and shape our reality.\'"

    "You'd think that a merchant guild wouldn't bother creating such a philosophical motto and instead advertise {i}'buy one, get one'{/i} dragon cruise seats every holiday season."
    ...
    voice "audio/voice/claude/claude_01_take_01.ogg"
    $ claude_name = "Unknown"
    show lars
    Claude "Who on Divonia is mumbling this loud to themselves early in the morning?"

    voice "audio/voice/claude/claude_02_take_02.ogg"
    show lars
    Claude "I'm losing my beauty sleep over here."
    $ claude_name = "Claude"

    "I steal a glance from my perch atop our dragon and it looks like one, or should I say, the {i}only{/i} passenger, has woken up in quite a grumpy manner."
...
label playfully_surprise_him:
    ...
    "Something tells me I should surprise him, just to cheer up the mood."
    ...
    voice "audio/voice/claude/claude_05_take_02.ogg"
    show lars
    Claude "Haaa, you always find a way to turn the tables, don't you?"

    voice "audio/voice/claude/claude_06_take_01.ogg"
    show lars
    Claude "Although..."
    ...
    show claude smile at center:
        ...
        parallel:
            linear 1.0 zoom 1.50

    pause 1.5
    voice "audio/voice/claude/claude_07_take_02.ogg"
    show lars
    ...
    "Speaking like the true flirt that he is, Sir Claude effortlessly slips into his act as soon as he wakes up."
...
label resist_the_urge_to_surprise_him:
    ...
    show claude serious at right with dissolve
    "It's best that I focus on piloting our dragon first. Otherwise, I'll never hear the end of it."
    ...
    pause 0.5
    voice "audio/voice/claude/claude_08_take_03.ogg"
    show lars serious
    Claude "What a boring reaction. I expected more spunk from you..."
   
    voice "audio/voice/lars/lars_008_take02.ogg"
    show lars serious
    Lars "Ugh, never mind then. Hmph!"

    "Speaking with the playful sass that defines him, Sir Claude effortlessly slips into his act as soon as he wakes up."

label C_1_End:

    "On the same note, it's truly a wonder how he even managed to stay asleep throughout our entire journey, considering the lack of proper seating arrangements on our new dragon ship."

    "However, Sir Claude has always been notorious for his resourcefulness in such moments, owing to his history of travels and adventurous ordeals, despite his {i}comfortable{/i} upbringings."

    "I'm getting distracted again. Time to refocus and get back to work."

    voice "audio/voice/lars/lars_009_take01.ogg"
    show lars
    Lars "I will return to my duties, then, Sir—"

    voice "audio/voice/claude/claude_09_take_02.ogg"
    show claude shocked
    show lars
    ...
    voice "audio/voice/claude/claude_10_take_01.ogg"
    show claude smile
    show lars
    Claude "Now that I think about it, what were you talking to yourself about?"

    "Switching up the conversation whenever it works against his word, what else did I expect."

    "Then again, his exceptional gift for conversation as a merchant just had a way of clicking with my piloting skills, though I wouldn't admit that out loud."

    "Whether it was going on expeditions, dealing in trades, or connecting with the quirky passengers we often had..."

    "We always made an efficient team. Maybe even the best among all the guild members."

    voice "audio/voice/claude/claude_11_take_02.ogg"
    show lars
    ...
    voice "audio/voice/claude/claude_12_take_01.ogg"
    show claude shocked
    show lars
    Claude "Who knows, maybe one day, I'll surprise you with a confession that will leave you speechless."

    "Once he begins, there's no stopping his relentless flirting. Might as well shift my focus to something else... like our very new dragon!"

    hide claude shocked with dissolve
    show spotsy with dissolve

    "I reach out, my hand confidently caressing the head of our newest guild member who I hope I'm taking good care of."

    "Her eyes meet mine in and in a show of trust, her scale's part open, revealing mesmerizing roseate flames simmering underneath."

    voice "audio/voice/claude/claude_13_take_03.ogg"
    show lars
    Claude "Don't let your attention wander off too much, Captain."

    "Sir Claude's voice carries a subtle touch of displeasure as he observes me caressing Spotsy's head."

    "Maybe the uncomfortable seating arrangement is getting to him."
    
    voice "audio/voice/claude/claude_14_take_02.ogg"
    show lars
    Claude "You can spare the royal treatment. She's just a glorified lizard that could use a few mint leaves."

    show smoke

    "As if to express her annoyance, Spotsy lets out a flushed, puffy plume of smoke from her nostrils. A low rumbling note resonates from her throat, a clear indication of her irritation."
    ...
    voice "audio/voice/claude/claude_16_take_02.ogg"
    show lars serious
    Claude "She doesn't like it, hmm... that just makes me want to do it even more though."
    
    voice "audio/voice/claude/claude_17_take_01.ogg"
    show lars serious
    show claude serious with dissolve
    show claude serious at jp
    show lars serious
    ...
    voice "audio/voice/claude/claude_18_take_02.ogg"
    show lars serious
    Claude "I could also argue that I don't want to end up as some unfortunate passenger who prematurely expires and transports to the Earthly realm just because you were adoring our new dragon ship."
    
    voice "audio/voice/claude/claude_19_take_02.ogg"
    show claude shocked
    show lars serious
    Claude "There have been one too many incidents like that lately."

    "His sudden change of topic leaves me slightly bewildered. I withdraw my hand from Spotsy's head, and she shakes her head as if still searching for my comforting touch."

    show claude smile
    "In contrast, a mischievous grin now graces Sir Claude's face, as though the earlier dip in his mood near Spotsy never happened."

    "Maybe the problem wasn't the seats after all..."
    ...
    voice "audio/voice/claude/claude_20_take_03.ogg"
    show lars sad
    ...
    voice "audio/voice/claude/claude_21_take_02.ogg"
    show claude shocked
    show lars
    Claude "Tsk, tsk, tsk! Already thinking of replacing me with someone else, are you, Captain?"
    ...
    "Sir Claude has always been the most spirited member in our guild when faced with adversity."

    "Must feel great to not have any worries and be nonchalant about everything."

    voice "audio/voice/claude/claude_23_take_03.ogg"
    show claude sad
    show lars
    Claude "Ah, how gladly I would take their place if I could..."

    voice "audio/voice/claude/claude_24_take_03.ogg"
    show lars 
    Claude "Life can get pretty boring when you have everything you need in the palm of your hand."

    "Always trying to satisfy his thirst for adventure... but that's part of his charm, I suppose."

    "I could hardly recall a day when Sir Claude didn't turn a simple task into a grand quest. He always was, and still is, on the lookout for opportunities to embark on new escapades."

    voice "audio/voice/claude/claude_25_take_02.ogg"
    show claude smile
    show lars
    ...
    voice "audio/voice/claude/claude_26_take_03.ogg"
    show lars narration
    Claude "Well, I suppose it's my mistake for attempting to catch the attention of a certain dragon-obsessed pilot. Awe, what will become of my grandiose confession now?"
    ...
    voice "audio/voice/claude/claude_27_take_02.ogg"
    show lars
    Claude "No need for the empty flattery."
    
    voice "audio/voice/claude/claude_28_take_02.ogg"
    show lars
    Claude "I've had my fill of it thanks to a {i}certain{/i} family name."
    
    "As is his custom, Sir Claude deftly redirects the conversation whenever the topic of his family is brought up."

    "I used to wonder if he was doing so to maintain his privacy as a renowned heir with a diamond spoon, but despite the many years we spent together as partners, the sentiment never changed."

    voice "audio/voice/claude/claude_29_take_02.ogg"
    show claude smile with dissolve
    show lars
    Claude "However, you need to make sure to take care of her well since I did make quite the effort for her exchange."

    "What effort could he be talking about? The person we negotiated with today eagerly handed over all his prized possessions the moment he heard the {i}'Dupont'{/i} surname."

    voice "audio/voice/lars/lars_026_take02.ogg"
    show claude
    Lars "It was hardly a fair exchange at that point."
    
    voice "audio/voice/claude/claude_30_take_02.ogg"
    show claude sad
    show lars serious
    Claude "Well, that's the con of having an outrageously high-class family name like mine, I suppose. Hmph, makes one's trade prone to being {i}disgustingly{/i} easy."
    ...
    voice "audio/voice/claude/claude_31_take_01.ogg"
    ...
    "Question is, what if it turns out to be hazardous or a curse?"
    
    "Then again, he'd certainly enjoy tackling something like that instead of dwelling on any potential dangers..."
    
    voice "audio/voice/lars/lars_028_take.ogg"
    show lars narration
    Lars "Scrutiny would have been welcomed."
    
    voice "audio/voice/claude/claude_32_take_03.ogg"
    show lars narration
    Claude "I was planning to spice things up a bit, so why not embrace the opportunity of a possible adventure?"

    "Right... because who wouldn't jump at the chance to receive an artifact with no known origins, suddenly materializing out of thin air, and with no apparent acquisition date?"

    hide lars_stuck with dissolve
    
    voice "audio/voice/claude/claude_33_take_02.ogg"
    show claude serious at center
    with dissolve
    show lars
    Claude "Captain, your facial expression is practically giving a masterclass in sarcasm. Oh, you might want to hide it under a thin layer of worry or, Divs forbid, {i}concern{/i} for your partner."
...
label apologize_for_teasing_him:
    ...
    voice "audio/voice/claude/claude_34_take_02.ogg"
    show lars 
    ...
    voice "audio/voice/claude/claude_35_take_03.ogg"
    show claude shocked at right with move
    show lars 
    ...
    voice "audio/voice/claude/claude_36_take_02.ogg"
    show claude shocked with dissolve:
        xzoom -1.0
    show lars
    ...
    show lars
    Claude "Nothing you say from here on out will ever mend our broken bond."

    show claude smile
    Lars "You’re irreplaceable to me—"
    ...
    Lars "And your merchant skills are unmatched—"

    show lars
    Claude "Yes, of course, that's not even debatable."

    "Clearly, he's on a quest for eternal satisfaction at this breathtaking pace. This is getting tiring, best to cut this session short."

    Lars "That's about it, nothing else seems to come."

    "Or at least, not that I'm going to tell you out loud."
    ...
    pause 0.5
    voice "audio/voice/claude/claude_37_take_02.ogg"
    show lars
    ...
    voice "audio/voice/claude/claude_38_take_01.ogg"
    show claude smile
    show lars
    ...
    show claude
    "My fur prickles with anticipation. I can sense my ears perking up, betraying my keen interest in his next words and what he could possibly want from me."

    voice "audio/voice/lars/lars_033_take02.ogg"
    show lars
    Lars "A gift? For you? But you already have everything you need."

    "His family has his pockets lined with all the gold and treasures imaginable too, so I can't see what he'd want from someone of my caliber. The best I can offer him is a handful of dragon treats."

    voice "audio/voice/claude/claude_39_take_04.ogg"
    show claude smile
    show lars
...
label continue_teasing_him_even_more:
    ...
    voice "audio/voice/claude/claude_40_take_03.ogg"
    show lars
    Claude "Oh, please, [Lars], you should know better than blabbering {i}Dupont{/i} recklessly."
    ...
    "Leaning close, his fingertips gently brush against my cheek, leaving a trail of warmth. His gaze, bathed in waves of sunlight, captures mine with unyielding intensity."

    "As his lips draw near my ear, his voice deepens, resonating with a seductive allure that sends shivers down my spine."
    
    voice "audio/voice/claude/claude_41_take_01.ogg"
    show claude smile with dissolve
    show lars blush
    Claude "See? I used your name, so you have to call me by mine too... {i}without{/i} the tiring title."

    voice "audio/voice/claude/claude_42_take_01.ogg"
    ...
    "The sudden remark takes me by surprise, even though it's not the first time I've heard Sir Claude make such a comment. After all, he possesses a captivatingly flirtatious nature, effortlessly weaving his charm into every interaction."

    voice "audio/voice/lars/lars_037_take01.ogg"
    show lars blush
    Lars "W-w-what are you saying all of a sudden?! Did you lose your mind?"
    
    voice "audio/voice/claude/claude_43_take_01.ogg"
    ...
    "With little time to question his truthfulness, I instinctively place my hands on my ears, hoping to shield any trace of vulnerability that might betray my reaction to his words."
    ...
    show lars blush
    Lars "My years of experience have honed my resilience and steeled my resolve. I cannot allow myself to be easily affected whimsical words, no matter how charismatic Sir Claude may be!"

    show lars blush
    Claude "Awe, did I get under your skin, Captain? So much that you had to switch to third-person commentary?"

    "Sir Claude remains unfazed by my momentary embarrassment except for a triumphant smile."
...
label C_2_End:
    ...
    show claude smile
    show lars
    Claude "Anyways, let's save this conversation for later, shall we?"
    ...
    "I glance downward, and witness our destination near the sea slowly come into view."
    ...
    "Like an artist painting delicate strokes on a canvas, Master Sylvian has already lined up the location with an array of enchanting flowers."

    "Each bloom carefully chosen to mark our path with a vibrant array of sunflowers and roses."
    
    "Their vivid colors stand out, captivating the eye and creating a striking contrast against the backdrop of the serene oceanic landscape."

    "The gentle breeze carries the sweet fragrance of the flowers, adding to the enchanting ambiance"
    ...
    with dissolve
    show lars
    Claude "I'd be inclined to say that you didn't manage to tap into our dragon's full potential Captain."
    
    show lars
    Claude "Owning up to how I stole your attention for more than half, {i}or better yet{/i}, the entire ride."
    ...
    "He locks eyes with me, and I can't help feeling a tad self-conscious under the weight of his declaration, whether it was actually meant for me or not."
    ...
    "As the sole passengers aboard, guiding Spotsy in her safe descent was a seamless task."

    "The proximity to the water offers a perfect opportunity for her to release some pent-up energy too."

    "Hopefully, she's not too tired from the journey. I'd hate to burn her out from the get-go. First impressions matter for dragons as well, especially when it concerns their pilots"

    "However, once we disembark, our attention turns to the tall and slender magician making his way towards us."
    ...
    "A warm smile graces his lips, accompanied by the graceful flutter of his obsidian wings."

    "With a hushed incantation, the brim of his hat blossoms into a vibrant tapestry of roses and sunflowers, their delicate petals unfurling in a mesmerizing display."
    
    "The air is instantly infused with their soft fragrance, which mingles with a refreshment spell."
    ...
    voice "audio/voice/claude/claude_44_take_03.ogg"
    show claude serious
    show sylvian serious funny
    show lars
    Claude "Feel free to skip the cliché warm welcome, Boss Sylvian. I know you're probably itching to have [Lars] by your side, but—"

    voice "audio/voice/lars/lars_042_take01.ogg"
    show lars serious
    Lars "Sir Claude!"

    "Ugh, here we go again. He barely lasted a minute before launching into teasing his next target. Though for some reason, he'd always unnaturally tense up when it came to Master Sylvian."

    "Though, thank the Divs that Master Sylvian can ignore his petty attempts to rile him up."
    
    "You could say he's the only reason our guild hasn't fallen apart yet. It's precisely his serene composure that makes him the leader he is."
    
    voice "audio/voice/claude/claude_46_take_02.ogg"
    show lars serious
    ...
    show sylvian
    show lars
    Sylvian "Never mind him [Lars]. It's best to let the spotlight find its own stage rather than chasing after it."
    ...
    voice "audio/voice/claude/claude_47_take_02.ogg"
    show claude shocked
    show lars
    Claude "Eh, I did promise to reward you later, didn't I? Drum roll please ~"

    play sound sfx_drum_roll
    "Tension fills the air as the anticipation builds up, drawing everyone's attention. Then, in a dramatic display, he spreads his arms wide, showcasing a grand reveal which is..."

    stop sound fadeout 2.0
    "... nothing?"

    voice "audio/voice/claude/claude_48_take_03.ogg"
    ...
    voice "audio/voice/claude/claude_49_take_01.ogg"
    show claude smile
    show lars
    Claude "No need, my dear Captain. Boss Sylvian can handle it just fine."
    
    voice "audio/voice/claude/claude_49_take_02.ogg"
    show lars
    Claude "You and I have been quite busy, and the artifact box is heavy enough to demand a touch of fresh energy."
...
label ask_Sylvian_grab_cargo:
    ...
    voice "audio/voice/sylvian/sylvian_005_take03.ogg"
    show lars
    ...
    show sylvian sad
    show lars
    Sylvian "{size=*0.85}I also wanted to spend some time with you..."
    ...
    voice "audio/voice/claude/claude_50_take_03.ogg"
    show claude smile with dissolve
    show claude smile at jp
    show lars
    Claude "Awe, you chose to stay with me."
    
    voice "audio/voice/claude/claude_50_take_04.ogg"
    show lars
    Claude "I'm touched, Captain."

    voice "audio/voice/claude/claude_51_take_01.ogg"
    show lars
    ...
    "His hands gently encircle my waist, drawing me closer to him as he whispers the last part of his sentence."

    "His eyes, reminiscent of pools reflecting molten sunlight, lock onto mine, harboring a mischievous spark that dances within them."

    "While I usually dismiss this as him being more touchy-feely than usual, his last comment makes me think otherwise."

    "Not to mention, beneath his playfulness, there lurked a subtle undertone of his usual competitive spirit."
    
    "As if he and Master shared a friendly rivalry, each vying to outdo the other in their unique way."

    voice "audio/voice/sylvian/sylvian_blooper_001.ogg"
    show lars blush
    Sylvian "Achoo!"
    ...
    voice "audio/voice/claude/claude_52_take_02.ogg"
    show lars
    ...
    voice "audio/voice/sylvian/sylvian_blooper_003.ogg"
    show lars
    Sylvian "Achoo, I-I I'm so sorry, I-I just, I must have grown a flower that I was allergic too, I didn't know that could happen to be honest. Right, uhm... where were we?"

    "Strange, perhaps even geniuses like him have their moments of imperfection. Though the timing was oddly specific."
    ...
    voice "audio/voice/claude/claude_53_take_01.ogg"
    show lars
    ...
    "Master Sylvian, without uttering another word, gracefully takes flight, his wings resembling those of a majestic black swan."
    
    "Each feather ruffles in the breeze, catching and refracting slivers of sunlight, creating a mesmerizing shimmer which I didn't know was possible."
    
    show rory at center_2right with moveinright
    
    "However, a familiar voice rings in the air before I can observe any further."

    $ rory_name = "Unknown"
    voice "audio/voice/rory/rory_001_take02.ogg"
    show lars
    Rory "{bt}{size=*1.25}Oh Clauuuuuuuuuuuuudy~{/bt}"
    $ rory_name = "Rory"
    
    show claude smile at center_3left with move

    voice "audio/voice/claude/claude_55_take_02.ogg"
    show lars
    Claude "{bt}{size=*1.25}Roryyyyyyyyyyyyy~{/bt}"

    "Wow, he actually managed to sound less playful for once–"

    voice "audio/voice/claude/claude_55_take_04.ogg"
    show lars
    Claude "{i}Rory rory rory rory rory rory rory rory roryyyy~{/i}"

    "Never mind. I stand corrected."

    "A figure emerges from where Master Sylvian stood just a few seconds ago, and to my pleasant surprise, it is none other than my childhood best friend. "

    voice "audio/voice/rory/rory_002_take01.ogg"
    show rory angry 
    show lars 
    Rory "I believe I mentioned that if I ever catch, I'd pluck out your lizard eyes to adorn my newest puppet, Agatha."

    show rory angry at jp
    voice "audio/voice/rory/rory_003_take01.ogg"
    show lars 
    Rory "You should know that my threats work quite effectively, especially with how Brittina's dress is shimmering with the scales you've kindly donated... in your sleep, of course."

    "True to her lineage as a bull descendent, Rory possesses a fiery temperament and is quick to charge at those who annoy her."

    "Her family, the Kyoko blacksmiths, and the Dupont merchants have been locked in a spirited rivalry for generations."
    
    "Both families have passed down their competitive natures to their heirs, adding fuel to the fire."

    "However, Rory was an exception to the traditional path of the Kyoko family. While blacksmithing was the cornerstone of their legacy, Rory's talents lay elsewhere."
    
    "She found her passion in puppet shows and other forms of artistic expression."
    ...
    voice "audio/voice/claude/claude_56_take_02.ogg"
    show claude shocked
    show lars happy
    Claude "Look at our hot-tempered bull, breathing fire as soon as she lays eyes on me."

    voice "audio/voice/claude/claude_57_take_01.ogg"
    show claude smile
    show lars happy
    ...
    "It's truly a marvel how two individuals so alike can harbor such profound disdain for each other."
    
    "As if that weren't enough, Sir Claude, with his stellar nicknaming skills, expertly fans the flames."
    
    "I'm still trying to figure out how he coined the name {i}'Little Rory'{/i} in the first place— whether it was the height difference, the perpetual little sibling energy between them, or the sheer delight he took in seeing Rory immensely bothered whenever he mentioned it." 

    "Fortunately, Rory never failed to deliver in comebacks, though hers always carried a more imaginative flair."
    ...
    voice "audio/voice/claude/claude_58_take_02.ogg"
    show lars serious
    Claude "Now, now, I would have to say these finely braided silver strands that I've so kindly donated to you are what's bringing half the revenue for your puppet shows, aren't they {i}little Rory{/i}?"
    ...
    voice "audio/voice/claude/claude_59_take_01.ogg"
    show rory
    show lars sad
    ...
    with move
    show sylvian zorder 3 at right with moveinright

    "Thankfully, Master Sylvian swiftly intervenes, diffusing the tension with his timely return. It's always a relief when he steps in; the two never listen to me when they start arguing, but his authority commands attention."
    ...
    "The weight of anticipation fills the air, drawing all eyes toward the mysterious object, and momentarily, the conflict is forgotten."
...
label tell_Claude_grab_cargo:
    ...
    voice "audio/voice/claude/claude_60_take_02.ogg"
    show claude shocked
    show claude shocked at jp
    show lars
    Claude "I-I-I-I I'm shocked, Captain."
    
    "Not very convincing as a shocked person–" 

    voice "audio/voice/claude/claude_61_take_03.ogg"
    show lars
    Claude "You even ignored my request about dropping the {i}Sir{/i} part."

    "That sounds better. He might have been actually confused for a moment."
    ...
    "All of a sudden, Master Sylvian raises his hand in a deliberate motion, bringing it towards the brim of his hat."

    "With a gentle touch, a magnificent bouquet unfurls and blooms forth, as if conjured by the grace of his gesture."
    ...
    with dissolve
    "Sunflowers rise proudly, while lavender blossoms intertwine. Brilliant clusters of marigolds sprout forth as well."

    "I remember that his hat was one of his personal crafts, a magical creation that bloomed flowers according to his mood."

    "It's unfortunate that I'm not well-versed in flower languages; otherwise, I would be able to decipher the heartfelt messages he wishes to convey through these enchanting floral gifts."

    "Nonetheless, I can't help but feel treasured whenever he gives me gifts. After all, I've noticed that he hasn't given this kind of gift to anyone else, and the thought warms my heart for some reason..."
    ...
    voice "audio/voice/claude/claude_62_take_01.ogg"
    show lars
    Claude "Quite the showmanship, Boss."

    voice "audio/voice/claude/claude_63_take_01.ogg"
    show claude serious
    show lars
    Claude "Though I wonder if Captain over here got the message in your {i}subtle{/i} gesture."

    show sylvian blush
    "Without regarding his comment, Master Sylvian comes closer and presents me with the bouquet, throwing a smile at Sir Claude who promptly leaves with his back towards us."
    ...
    show lars blush
    Sylvian "But even still, flowers are the silent poets of our emotions, conveying in colors and scents what words... often struggle to express."
    ...
    show claude at center_2left with dissolve

    voice "audio/voice/claude/claude_64_take_02.ogg"
    show lars serious
    Claude "So glad that that nauseating scene is over."
    ...
    voice "audio/voice/claude/claude_65_take_03.ogg"
    show lars serious
    Claude "Mhm, sure, sure, sure, whatever."
    ...
    show sylvian at center_3right with move
    "As Sir Claude takes his leave, his silver lizard tail gracefully sways behind him, reminiscent of the rhythmic movements of the sea."
    
    "His scales, resembling those of the majestic dragons I often encounter in my journeys, captivate my gaze with their intricate detailing, despite their diminutive size."
    ...
    voice "audio/voice/rory/rory_004_take01.ogg"
    show lars happy
    Rory "You're here [Lars]! Awe, I missed you so much."
    ...
    "The figure that emerges from where Sir Claude stood just a few seconds ago, is none other than Rory, my childhood best friend."
    
    "True to her lineage as a bull descendent, Rory possesses a fiery temperament and is quick to charge at those who annoy her."

    "Under Master Sylvian's guidance, she apprenticed as the guild's head of finance, helping us gather funds for every mission through her puppet shows."

    "Her unwavering support is something we genuinely owe our success to."
    ...
    "Rory's family, the Kyoko blacksmiths, and the Dupont merchants have been locked in a spirited rivalry for generations."
    ...
    "Rory offers a faint smile, her thumbs anxiously twiddling together."
    ...
    voice "audio/voice/claude/claude_66_take_01.ogg"
    show lars 
    ...
    with moveinleft
    "Speak of the devil, Sir Claude makes his entrance with the large ornate box held tightly by his tail. His eyes glimmer with a mixture of anticipation and excitement."
    ...
    show box with dissolve
    "However, rather than keeping it for himself, he extends the box towards me."
...
label CS_1_End:
    ...
    "As the heavy weight of the artifact transfers to my hands, I feel a sense of responsibility settle in."
    ...
    show lars
    Sylvian "If there's one thing my academic days have taught me, it's to not overwork when there's an easier alternative available."
...
label accept_his_offer:
    ...
    "Something is telling me I should accept his offer."

    show lars
    Lars "Yes, please. This box isn't doing me any favors."

    show rory at jp
    voice "audio/voice/rory/rory_018_take02.ogg"
    show lars
    Rory "Oh {bt}Claudyyy{/bt}, how about you tell me what the trip was like?"

    voice "audio/voice/claude/claude_67_take_03.ogg"
    show claude shocked
    show lars
    Claude "Agh, hold on, little Rory, where do you think you're taking me all of a sudden, you—"
    ...
    "Instantly, Master Sylvian utters an incantation and a sense of liveliness washes over me, like the exhilaration that follows after completing a marathon."
    ...
    show lars narration
    Lars "Haha, nothing to worry about! But did you know, Master Sylvian? I was researching Spotsy and as part of the {i}Roseate Flame{/i} species, the intense temperature generated through their breathing process can cause the air pockets under their scales to expand—"
    
    show lars narration
    Lars "Their flushed distortions aren't for mere show either, Rory mentioned that certain blacksmiths hire them for their forging practices since the heat produced is exceptionally hotter than regular flames, making it a valuable resource for—"
    ...
    "He takes my hand into his own, slowly tracing circles on my palm. His touch feels warm, and there's a slight hint of perspiration, as if he's nervous about holding it."

    voice "audio/voice/sylvian/sylvian_025_take01.ogg"
    show lars
    Sylvian "Breathe for 3 seconds... hold it for 6... now release it for 9 seconds..."

    "Obediently, I follow Master's instructions, allowing my breath to gradually slow down. Despite my heart still thumping in my chest, each measured inhale and exhale brings a sense of calm that envelops me, grounding me in the present moment."
    ...
    show lars
    Sylvian "I mean, who wouldn't want to be praised by someone they admire... I mean, not that I admire you in {i}that{/i} way, but ughhh... never mind!"

    "Suddenly, he takes hold of the tips of my fingers, as if he's shying away from holding my hand fully. I'm sure my ears are flushed all the way from the sweetness of his shy gesture."

    voice "audio/voice/claude/claude_15_take_02.ogg"
    Claude "Hrrrgh ahem ahem."
    ...
    show sylvian blush
    "In the blink of an eye, Master Sylvian's demeanor shifts. He turns his head away, almost as if he's trying to conceal his reaction to Claude's statement."
    
    "Yet, even from behind, I catch a glimpse of his ears slightly reddening."

    voice "audio/voice/claude/claude_69_take_02.ogg"
    show lars blush
    ...
    "Wow, it's not often that he raises his voice like that."
    ...
    show lars
    Sylvian "{size=*0.85}Maybe my own lack of directness caused this in the first place."
...
label reject_his_offer:
    ...
    show sylvian sad zorder 2
    show rory zorder 3
    "He looks dejected, and now I feel guilty about declining his kind proposal."
...
label S_1_End:
    ...
    "After a few seconds of inspection without any notable reactions, Master Sylvian breaks the silence."
    ...
    "I direct my gaze towards the opened box, feeling the weight of everyone's anticipation upon me. Carefully lifting the necklace from its resting place, I note its light size despite the box's heftiness."
    ...
    show claude smile
    show lars
    Claude "We have no idea about its origins yet, but that's the fun part of it."

    show lars
    Claude "Not to mention, I could never let go of such a mysterious prize, I need to uncover its secrets all for myself..."

    "Sir Claude's expression undergoes a striking transformation, shifting from one of casual curiosity and playful mirth to that of intense obsession."
    
    "His eyes fixate unwaveringly on the artifact, a glimmer of determination and fervor dancing within them."

    "It is no secret that he possesses a deep-seated fascination with challenges and trials. Though he seldom shares the reasons behind his unwavering obsession, his eyes betray his inner excitement whenever faced with such an opportunity."
    ...
    show lars
    Claude "Boss Sylvian, you have quite the reputation in the academic world for your discoveries and inventions."
    
    show claude:
        zoom 1.0

    show lars
    Claude "If someone were to understand the potential behind this artifact, it would be none other than you."
    ...
    "As always, neither side showed any signs of stopping their retort. After all, the first to stop would be the first to lose and their competitive nature wouldn't allow them this leeway."
    ...
    show lars serious
    Lars "Sir Claude, that's not like you—"
    ...
    show lars serious
    Lars "Come on Rory, not you too—"

    show sylvian serious funny at jp
    show lars serious
    Sylvian "{size=*1.25}Rory, Claude, it's time to stop." with vpunch
    ...
    "Master Sylvian's voice echoes through the air, instantly commanding everyone's attention and calming the conflict-ridden atmosphere."

    "While he typically exudes a collected composure, there are occasions when he utilizes his authoritative voice to instill a sense of order among those around him."

    "It's a captivating contrast, witnessing the guild leader within him command respect and bring about a calm atmosphere."

    show sylvian with dissolve
    show lars
    Sylvian "Let us embrace empathy's grace and refrain from jesting, for each soul carries its own unique beauty. Whether it be descendants of lizards, foxes, swans, or bulls."
    ...
    "As Sir Claude and Rory move away to not bump heads again, I quietly make my way towards Master Sylvian."
    ...
    "A shy smile graces Master Sylvian's lips as he gently rests his hands on my shoulders. The feathers of his swan-like wings delicately brush against my back, imbuing me with a sense of tranquility and ease."
    ...
    "He's acting a bit strange, what should I do now?"
...
label poke_further_and_ask:
    ...
    "It's not like Master Sylvian to act like this, and seeing him slightly melancholic leaves me with a sense of concern."
    ...
    "He shakes his head a bit, as if trying to clear his thoughts."
    ...
    "Summoning all my courage, I move closer and grasp Master Sylvian's hands, locking my gaze with his."
    ...
    "The initial shock on his face gives way to a warm and genuine smile, a flicker of happiness illuminating his eyes."

    voice "audio/voice/lars/lars_065_take01.ogg"
    Lars "I'm sorry if it sounds like I'm trying to, you know, suck up to you or ask for something."
    
    voice "audio/voice/lars/lars_066_take01.ogg"
    Lars "That's really not my intention at all. It's just— well..."
    
    voice "audio/voice/lars/lars_066_take02.ogg"
    Lars "I tend to be pretty straightforward, especially when dealing with stray dragons. I mean, not that I'm saying you're anything like a stray dragon! I guess what I'm trying to say is, ugh..."

    voice "audio/voice/sylvian/sylvian_036_take03.ogg"
    show lars
    Sylvian "Heh! Forgive me, I just- haha..." with vpunch
    ...
    "I shake my head in mock frustration, burying my face in my hands. Master Sylvian always falls for these antics, especially when someone asks for his help or a favor."
    ...
    "As if understanding my need for reassurance, he gently pets me on the head, softly rubbing my ears in the process."
...
label joke_about_his_statement:
    ...
    "In an instant, the atmosphere shifts, and a wave of melancholy washes over Master Sylvian. His hands, once tranquil, now tremble slightly, and the furrow on his brow deepens as if he's grappling with memories etched on his face."

    "His jaw tightens, a silent struggle playing out in the subtle lines that trace his expression. It's as if he's transported himself back to moments he'd rather keep buried, and the weight of untold stories lingers in the air."

    voice "audio/voice/lars/lars_070_take01.ogg"
    show lars sad
    Lars "Uhm, Master, you might have misunderstood something, I meant that we enjoy your company as fellow guild members, not that—"

    voice "audio/voice/sylvian/sylvian_044_take03.ogg"
    show lars sad
    Sylvian "It's okay [Lars], I'm just getting upset on my own, that's all."

    "My words don't seem to reach him anymore, it seems."
...
label S_2_End:
    ...
    "Never mind, he was probably feeling sentimental."
    ...
    "As everyone settles under Master Sylvian's gentle yet authoritative command, he takes hold of the artifact, brimming with curiosity."
    ...
    show lars
    Sylvian "It eerily resembles an artifact that I had previously seen in the Archmage's tower."
    
    show lars
    Sylvian "A one-of-a-kind necklace with a similar gemstone belonging to a family of dragons with our very own half-human, half-animal traits as descendants."
    ...
    "Rory's eyes widen to an almost comical extent, as if they're on the verge of rolling out of their sockets."
    
    "As for Master Sylvian, he merely closes his eyes, whether he's focusing on what Sir Claude is saying or mentally preparing himself for any upcoming conflicts... I can't tell."
    ...
    "A deft rescue, just in time to avert another impending disaster."
    ...
    show claude smile
    show lars
    Claude "Captain, how about you wear the necklace for now instead of little Rory? It's color suits your lovely hair, after all."
    ...
    show lars serious
    Claude "Don't worry; I plan on showcasing my intentions to you firsthand in a bit."
    ...
    show blink_necklace
    with dissolve
    "Alas, disregarding Sir Claude's comment, I take the moment to put on the necklace, the gemstone's ruby color captures my attention and I marvel at the curious glow that emits from it."
    
    "It's strange though, I don't recall the color being so vibrant. It's almost as if it's shining or signaling something."
    ...
    "Shaking off my trance, I hasten toward the others who have gathered ahead."

    "Master Sylvian deliberately slows his steps as I pass him. Looks like he'll be keeping a watchful eye over the rest of us as we go ahead."

    "Meanwhile, Sir Claude and Rory pick up their pace, engaging in a competition to see who can reach the puppet stall first."
    
    "Their banter fills the air as they exchange witty remarks, not holding back on their rivalry."

    "Hopefully, it'll be another day without any troubles here in Divonia and {i}Custodes Sylvae{/i}."
    ...
    "The town square pulsates with vibrant energy with the captivating tapestry of stalls embellishing the grassy pathway."
    
    "As I walk through this bustling scene, my attention is drawn to the medley of merchants enticing passersby with their wares, creating an atmosphere of enchantment and wonder."

    "The tantalizing scents of delectable dishes waft through the air, drawing in hungry travelers, including myself, with promises of culinary delights."

    show bg_3 at end_pan

    "As I stroll along, my mind wanders to my guildmates, and I can't help but imagine them donning different attire from the clothing boutiques."

    "My imagination runs wild with visions of my guildmates donning different attire from the stalls."
    ...
    "Rory comes to mind first as my best friend. A practical and independent soul, whose artistic flair and unique personality are effortlessly mirrored in her attire."

    "Her outfits are accessorized with charming trinkets. Practical short sleeves allow her to move with ease, while thoughtfully designed pockets serve as clever storage for her beloved tools and equipment for her puppet shows."
    ...
    "Particularly her emergency puppets, which always seem to come to the rescue in unexpected situations."

    hide rory with dissolve

    "Hmm... who else comes to mind?"
...
label master_Sylvian:
    ...
    "As a flower magician, Master Sylvian weaves his clothing with delicate floral spells, each stitch carrying the soft whisper of his incantations."

    "His fondness for deep, shadowy hues consistently manifests in his attire—a seamless blend of midnight-hued blossoms that effortlessly complement the color palette of his elegant, swan-like wings."

    "There's also his signature personally-crafted magician's hat."
    
    "He once mentioned that this unique accessory serves to stabilize the emotional energy he channels, transforming it into an array of different blooms."

    "I wish I had the ability to decipher the meaning behind the flowers that draw from his emotions."

    "Yet, my knowledge in this area primarily revolves around memorizing names of plants and herbs safe for dragons - avoiding accidental poisonings, preventing ailments, and ensuring respectful offerings, among other practical considerations."

    "Nevertheless, next to Master Sylvian, my understanding barely scratches the surface. He may downplay it, but getting to his level of expertise seems like it would take a century, if not more."

    "That's one of the many things I admire about him— being so knowledgeable yet never shying away from wanting to discover more about the world and the people around him."
...
label sir_Claude:
    ...
    "Sir Claude always holds his appearance with unparalleled pride. I can envision him draped in a new style of opulent faux fur and leather clothing curated from exotic lands courtesy of his family, and even his own, well-established connections."

    "Surrounded by a retinue of devoted servants, he could easily present with a garment thoughtfully designed to accentuate and showcase his glistening scales, and maybe even leave an opening for his enormous tail."

    "But, given his independent streak, I wouldn't be surprised if he goes with whatever catches his eye, not caring much about what's in vogue among the nobles or even paying attention to the advice of his fashionista advisors."

    "Just looking at him now, with those silver braids cascading down his back, I'm served a gentle reminder to do something about my own unruly fox fur and maybe tidy up my ponytail."
    
    "That's one of the many things I admire about him— being his own source of inspiration without having to make a conscious effort to appeal to others or impress them."
...
label CS_2_End:
    ...
    show lars
    Claude "Let it be known that I'm only helping out because I want to spend some more time with Captain [Lars] over here. Otherwise, I'd be indulging in a cool shade at my family's own trade post."
    
    show lars
    Claude "After all, who knows what new trinkets await to be blessed by my presence when I'm there."

    "The Dupont family are notorious for their array of foreign novelties; enticing visitors with a fascination for distant lands and cultures."
    
    "Their stalls are always filled with rare and luxurious items, each one carefully curated to capture the attention of potential buyers seeking something unique for an exorbitant price."
    ...
    show claude shocked:
        zoom 1.0
    "Ever the showman, he raises his eyebrows in mock shock, pausing with a light gasp. His forked tongue makes its appearance as his mouth gnaws open."
    ...
    show lars
    Claude "How about a friendly competition, then? May the best one, which couldn't be anyone other than me, win!"
    
    "It's always heartwarming to witness the genuine indifference people have towards my opinion."

    show lars
    Claude "... and the prize will be—"
    ...
    show lars blush
    Claude "Not so much a {i}proposal{/i}, but more of a heartfelt promise that you'll keep me in mind whenever you look at it. After all, you always accept Boss's bouquets and poems. Don't they count as gifts too?"

    show lars
    Lars "Well, sure, they do... but I can't picture him having flirtatious intentions like yours, right Master?"
    
    Lars "Not to mention, weren't you the one cracking confession jokes all the time anyway, Sir Claude? I'm sure it's no different this time."

    "As seconds stretch into an uncomfortable silence, I scan the room, hoping for any signs of acknowledgment. Yet, the absence of a single uttered word leaves me with an awkward feeling."

    "Sir Claude seems to already be lost in a daydream as he softly whispers to himself. It looks as if he's planning something important and couldn't care less about the current situation."

    "Meanwhile, Master Sylvian, who lingering inconspicuously in the background -to the point of escaping my notice- now stands quietly. His eyes fixed upon me, silently pleading for acknowledgment."

    "Who should I question about the intentions behind their gifts?"
...
label ask_Master_Sylvian_about:
    ...
    show sylvian sad at center with dissolve
    with move
    "It's best to approach Master Sylvian first, as he tends to take my words more seriously than Sir Claude does."
    ...
    "As if drawn in by the gravity of my serious question, he takes a deep breath and looks me directly in the eyes."
    ...
    Lars "Let's save that talk for later, per your wish then."
...
label ask_Sir_Claude_about:
    ...
    "It's best to approach Sir Claude first, since he tends to be more straightforward with his answers."

    show lars
    Lars "Why did you mention a ring, Sir Claude? I feel like you might be taking the teasing a bit too far today."

    voice "audio/voice/claude/claude_70_take_01.ogg"
    show claude shocked with dissolve
    show lars
    ...
    voice "audio/voice/claude/claude_71_take_02.ogg"
    show lars
    ...
    voice "audio/voice/claude/claude_72_take_02.ogg"
    show claude smile
    show lars serious
    Claude "Obviously, since the previous strategy didn't work on you so I have to take it up a notch."

    voice "audio/voice/claude/claude_73_take_03.ogg"
    show claude
    show lars serious
    Claude "Anyways, I have no qualms about covering the cost for the ring either."

    "Sounds like he's getting bored by my protests..."

    voice "audio/voice/lars/lars_080_take01.ogg"
    show lars serious
    Lars "But I said—"

    voice "audio/voice/claude/claude_74_take_01.ogg"
    show claude blush
    show lars blush
    ...
    voice "audio/voice/claude/claude_75_take_02.ogg"
    show lars serious
    ...
    voice "audio/voice/claude/claude_76_take_02.ogg"
    show claude serious
    show lars
    Claude "Need I remind you about Boss Sylvian's so-called {i}gifts?{/i}"

    "Master's presents are purely gestures of appreciation, but rings usually mean a lot more..."
    
    show lars
    voice "audio/voice/lars/lars_084_take02.ogg"
    show claude sad
    Lars "Although... some of my human passengers did mention gifting rings as accessories, is that what you meant?"

    show lars
    Claude "..."
    
    voice "audio/voice/claude/claude_77_take_01.ogg"
    show lars
    Claude "Maybe it's too soon for you to understand what I mean, Captain."

    "He runs his fingers through his hair, disturbing its meticulously arranged strands. The strong and distinctive scent of his sweet cologne wafts through the air as his gaze, like a magnetic force, fixates on me."
    
    "However, soon enough, a playful smile slowly adorns his face."

    voice "audio/voice/claude/claude_79_take_02.ogg"
    show claude smile
    show lars
    Claude "I'm not... {i}keen{/i} on the idea of losing what I've set my sights on to someone else, especially after being so straightforward about my intentions toward you all this time."

    voice "audio/voice/lars/lars_085_take01.ogg"
    show lars serious
    ...
    voice "audio/voice/claude/claude_80_take_03.ogg"
    show claude shocked
    show lars serious
    Claude "That's not what I meant..."

    show claude sad
    "He takes a deep breath, preparing himself as if he's about to reveal a significant secret."
    ...
    pause 1.5
    voice "audio/voice/claude/claude_81_take_02.ogg"
    show lars serious
    ...
    voice "audio/voice/claude/claude_83_take_03.ogg"
    show lars blush
    ...
    "Hearing Claude's earnest plea, I realize that this situation is more complex than I initially thought. His vulnerability and honesty tug at my heart. I nod, silently agreeing to have this crucial conversation in a more intimate setting."
    ...
    voice "audio/voice/claude/claude_85_take_02.ogg"
    Claude "Thank you, Captain. You can count on me to keep that promise. I might even add it to the keepsake I'll give you later on, haha."
    ...
    voice "audio/voice/claude/claude_86_take_02.ogg"
    show claude blush with dissolve
    show lars 
    ...
    "Before I have a chance to respond, Sir Claude closes in, wrapping me in a swift yet firm embrace. I catch a glimpse of a rare and momentary blush on his cheeks as he draws me closer."

    voice "audio/voice/claude/claude_87_take_01.ogg"
    show lars
    ...
    show lars
    Claude "Thank you, I'll make sure you don't regret it."
...
label CS_3_End:
    ...
    "We effortlessly blend into the diverse crowd of people, a mix of descendants with their distinct tails, wings, and horns representing various species."

    "Navigating a bustling town square like this would indeed be a challenge for regular descendants, particularly the scarce humans."
    
    "Yet, after riding countless dragons and becoming accustomed to their scales, a few feathers or fur become manageable obstacles."
    ...
    "It was no secret that Rory's performances provided the main source of funding for our expeditions and negotiations, making it a collective mission for us to occasionally advertise her shows."

    "The well-being of our guild's dragons heavily relied on those funds, and I cannot bear the thought of them going hungry or enduring any discomfort."
    
    "I would willingly starve myself before allowing such a situation to come up."
    ...
    "Before long, the collective footsteps of our group come to a halt, a unanimous signal that we had arrived at our destination."
    ...
    show claude shocked
    show lars
    Rory "I did want to pluck out the eyes for Agatha, but it's very hard to do that in his sleep especially since he's such a light sleeper."
    ...
    show rory at jp
    show lars serious
    Rory "I wouldn't put it past him to fake it or something. He's quite the attention-seeking piece of work. His entire persona is made up after all—"
    ...
    "Sir Claude's comment certainly came out of the blue, now they're both looking at me. What should I do now?"
...
label look_back_at_Master_Sylvian:
    ...
    show claude smile at center_1left
    show rory zorder 3 at center_left
    show sylvian sad zorder 2 at right
    with dissolve
    
    show lars serious
    "I glance at Master Sylvian, silently seeking his assistance."
    ...
    "I can see Sir Claude making quite a stupefied face due to the sudden interference. He probably didn't expect to be scolded like that."
    ...
    "Meanwhile, Master Sylvian regards me with a kind look as he reaches out and gently rubs my ears, soothing my embarrassment. He's become the sole focus in my line of sight right now..."
    ...
    voice "audio/voice/claude/claude_90_take_02.ogg"
    show lars serious
    ...
    show lars serious
    Lars "That's right, listen to Master Sylvian. He's shown genuine care and consideration for my feelings. However, with you, it feels like everything is either taken as a joke or a competition!"

    "He lets out a light sigh, seemingly contemplating his actions."

    voice "audio/voice/claude/claude_91_take_02.ogg"
    show lars
    Claude "... I suppose. Can't go against our esteemed Captain's wishes."

    voice "audio/voice/claude/claude_94_take_01.ogg"
    show claude smile
    show lars
    Claude "But I'll have you know that I'm not giving up anytime soon."

    voice "audio/voice/sylvian/sylvian_056_take03.ogg"
    show sylvian mad zorder 2
    show rory zorder 3
    show lars
    ...
    voice "audio/voice/claude/claude_95_take_01.ogg"
    show lars serious
    ...
    voice "audio/voice/claude/claude_96_take_01.ogg"
    show claude smile at jp
    show lars serious
    Claude "You see, it's {i}fun{/i} for me to see which of his buttons I can push."

    voice "audio/voice/claude/claude_97_take_02.ogg"
    show claude serious
    show lars serious
    ...
    show sylvian sad
    "A shadow crosses Master Sylvian's face at Sir Claude's comment, as if a nerve was struck deep within him."
    
    "The situation seems to be on the verge of getting out of hand, but my curiosity urges me to see how things will unfold."

    voice "audio/voice/claude/claude_98_take_03.ogg"
    show lars serious
    ...
    voice "audio/voice/claude/claude_100_take_02.ogg"
    show lars serious
    ...
    "I didn't anticipate Master Sylvian getting so worked up."
    
    "His hands tremble slightly as he delicately adjusts the side of his glasses, striving to sharpen his focus on Sir Claude's unexpectedly serious expression."

    "Now I'm even more curious to know what Sir Claude wanted to say, but I believe it's best to hold my tongue for now."
    ...
    voice "audio/voice/claude/claude_101_take_03.ogg"
    show claude shocked at jp
    show lars serious
    Claude "Tsk, tsk, tsk, outing me like this just because you couldn't handle what I said?"
    ...
    show rory at jp
    show lars
    Rory "Ahem, we have more important things to do right now. The show isn't going to start itself."
...
label look_back_at_Sir_Claude:
    ...
    show lars serious
    "I glance at Sir Claude, silently seeking his assistance."
    ...
    "He playfully winks, a certain charm in his eyes that's hard to ignore."
    
    "I'm pretty sure my tail is all ruffled up by the gesture, and who knows what state my cheeks are in right now— they always seem to be in a world of their own."
    ...
    "Sensing my gaze, he stretches his hand in my direction, entwining our fingers and pulling me closer until we're touching shoulder to shoulder."

    voice "audio/voice/claude/claude_103_take_02.ogg"
    show lars blush
    Claude "Ah, who knows what stage our relationship will reach in the very near future? Am I right, Captain?"

    "As if I can say anything in this embarrassing situation!"

    voice "audio/voice/claude/claude_104_take_02.ogg"
    show claude blush
    show lars blush
    Claude "Whether it's the way your cute tail wags around when you start rambling or how your ears perk up while listening to human tales, I can tell each and every one of them apart."

    "His scaly hand traces the contours of my ears. I could feel myself slowly heating up even more; my ears and tail are too sensitive for this."

    voice "audio/voice/claude/claude_105_take_01.ogg"
    ...
    voice "audio/voice/claude/claude_106_take_01.ogg"
    show lars blush
...
label CS_4_End:
    ...
    Rory "Anyways, try to gather the kids while I set everything up at the stall."
    ...
    "I make my way through the bustling groups of children, intent on grabbing their attention. The excitement in the air is palpable as their laughter and chatter fills the space."

    "It's best that I tuck the artifact beneath my equipment for now. Children are easily captivated by shiny objects, and I wouldn't want them accidentally pulling and damaging the necklace."

    "Taking a deep breath, I shout an announcement that echoes through the crowd."
    ...
    "The second I finish my announcement, I am bombarded by a swarm of children running towards me, their voices rising in a crescendo of excitement."
    
    "Little hands tug at my sleeves, pulling me in different directions, each child eager to share their thoughts or be part of the upcoming event."

    "Amidst the joyful chaos, I can see Sir Claude and Master Sylvian observing from afar, their watchful eyes filled with amusement and a glint of... something else that I can't quite put my finger on."
    ...
    show claude smile at center_2left with moveinleft
    show sylvian at center_2right with move
    ...
    show claude
    show lars
    Claude "And so he coughs again until his lungs give out, {i}wheeze{/i}, and {i}gag{/i}." with vpunch
    ...
    "Both guild members stand by my side. Sir Claude, with his innate charisma, effortlessly charms the children surrounding us."
    
    "Meanwhile, Master Sylvian, mesmerizes them with his expertly performed flower magic."
    ...
    "It was certainly true that Sir Claude had the tendency to act out against his family's wishes from time to time but according to the rumor mills, he didn't have a reason to."

    "The Dupont family, a lovely couple of lizard descendants, never strived Claude of love and affection."
    
    "Yet, from time to time, he seemed to entertain the notion of separating himself from them, as if he were born from a nameless hermaphrodite, where his true identity is simply 'Claude,' detached from the label {i}'Dupont.'{/i}"
    ...
    show lars
    Claude "With all due respect {i}Boss{/i}, but isn't that lack of ambition precisely why you're here with us today instead of boasting around the academia halls as the next possible Archmage of Divonia?"
    ...
    "I catch Sir Claude throwing a peek at me but he quickly switches his focus back to Master Sylvian."

    "When it came to dreams, Master Sylvian had garnered quite the reputation as the {i}Genius of the Century{/i} during his tenure at the Tower of Magicians in Divonia."

    "Although he rarely spoke about his past experiences, a glimpse into his emotions could be seen in the way his feathers drooped and his shoulders slumped with a sense of dejection whenever the topic came up."

    "Even his perpetual hunched posture served as a constant reminder of his time as a prestigious state magician. A time where he would work himself to the bone day and night with no rest in between."

    "Despite his current focus on flower magic, it was evident that Master Sylvian had a different area of expertise in the past. The secrets and stories behind his prior magic remained locked away, untold."

    "Not to mention, the formation of our guild seemed to be a deliberate decision he made in response to his experiences as an academician, though he seldom delves into the specifics."
...
label agree_with_Master_Sylvian:
    ...
    show lars
    Sylvian "Thankfully, Claude's influence hasn't rubbed off on you too much."
...
label agree_with_Sir_Claude:
    ...
    voice "audio/voice/claude/claude_88_take_03.ogg"
    show claude blush with dissolve
    show lars blush
    ...
    voice "audio/voice/claude/claude_89_take_02.ogg"
    show claude smile
    show sylvian sad
    show lars blush
...
label CS_5_End:
    ...
    "Rory suddenly approaches with a faint trace of concern etched on her face."
    ...
    "Whoa, hold on a second— what just happened here?"
    
    "It's such an eerie scene... the children, once animated, have now come to an abrupt standstill, their vibrant expressions frozen in unnatural stillness."

    "A surreal silence blankets not just them but everyone around us; it appears as though the world beyond our group has been caught in the grips of time."

    "The once-bustling atmosphere has dissipated, replaced by an unsettling quietude."
    ...
    "Acting on instinct, my hand reaches out, grasping at the figures frozen in time, attempting to break the eerie stillness that envelops them."
    
    "I shake them gently, yet with a growing sense of urgency, hoping to shatter the rigid spell that holds them captive."

    "Alas, my efforts yield no response, and the unnatural stillness persists,"
    ...
    "In the midst of my attempts to shake off the statues, a peculiar sensation courses through me."
    ...
    "The necklace I'm wearing grows warmer, its temperature gradually rising. Intrigued and compelled, I shift my attention towards it. It appears Rory has noticed it too."

    show lars
    Rory "Hold up! What's happening to the artifact right now? Take a look."

    "Instantly, everyone's gaze fixates on me."

    show lars
    Rory "It's blinking and shining like crazy! Do you think it has something to do with what's going on?"

    show lars
    Claude "What on earth could this piece of jewelry possibly have to do with anything?"

    show lars
    Rory "I don't know, but seriously, look around. It's like we're the only ones capable of moving, and everyone else is frozen in time. Weird, right?"

    "Was my earlier premonition about the necklace actually on the mark?"

    show lars sad
    Lars "What's going on, Mentor? Can't you do something about this?"
    ...
    "It appears Sir Claude spotted an approaching figure before any of us did, courtesy of his lizard-sharp eyesight."

    show sylvian serious funny
    show lars serious
    Claude "I think that it's watching us. Stay on guard."

    "As the tension in the air grows, I sense the presence of an unknown observer. It sends a chill down my spine, and I can feel my ears perk up."

    "A bead of sweat rolls down my forehead, and my ginger fur seems to prickle, almost as if it senses the imminent danger and excitement that lay ahead."
    
    voice "audio/voice/zephyr/zephyr_001_take01.ogg"
    show claude serious
    $ zephyr_name = "Unknown"
    show lars serious
    Zephyr "Muahahaha, oh, looks like some interesting Divs have entered my domain while I was occupied."
    ...
    "In an instant, Master Sylvian's incantation casts a protective shield of varying blooms and plants around us, shimmering with the combined energies of crystalline dews."

    show zephyr happy:
        xalign 0
        yalign 0
    
    "Even with the shield in place, my predator instincts stay sharp. The tension in the air is palpable, and I'm acutely aware of the figure's every move."
    
    "Time seems to slow down as I focus intently on its enigmatic presence, poised to react if any threat arises."

    show rory angry
    "With Rory by my side, her cutting tools poised for self-defense, we form a united front against the unknown creature."
    ...
    "Sir Claude, ever bold and quick-witted, leaps forward to question the puzzling figure. But before he has a chance to speak, the enigmatic figure's voice rings out."
    ...
    $ zephyr_name = "Unknown"
    show lars serious
    Zephyr "Ah no no, my brain cells will only acknowledge you as Scouty from here on out."
    ...
    "But you only have to remember one, which is {i}[Lars]{/i} ! But who knows what may happen if I say that out loud."
    ...
    voice "audio/voice/claude/claude_108_take_03.ogg"
    show claude shocked
    show lars serious
    ...
    show lars serious
    $ zephyr_name = "Unknown"
    Zephyr "Hey, Scouty, and the other two, I need my main character moment over here, stop blabbering so much."

    "I take a deep breath, frustration bubbling up within me as I watch the scene unfold. The figure's words are becoming increasingly difficult to make sense of."

    "I glance at my companions, hoping someone will step up and challenge their nonsensical monologue. We can't afford to let them dominate the conversation."

    "Come on, someone has to say something."

    show zephyr
    voice "audio/voice/zephyr/zephyr_015_take01.ogg"
    $ zephyr_name = "Unknown"
    show lars serious
    Zephyr "Ehem, as I was saying—"
    ...
    "Relief washes over me as Master Sylvian speaks up."
    ...
    play sound sfx_clap
    "Suddenly, the sound of a single clap pierces through the stillness. It's a sharp and commanding sound, one that demands our attention."

    voice "audio/voice/zephyr/zephyr_016_take01.ogg"
    $ zephyr_name = "Unknown"
    show lars serious
    Zephyr "{bt}Ooooh{/bt}, impressive words, especially considering your current disadvantage but I'll humor you this time."

    voice "audio/voice/zephyr/zephyr_017_take01.ogg"
    $ zephyr_name = "Unknown"
    show lars serious
    Zephyr "Since Smarty asked, it's time for the cliché introduction séance, the kind they do for games and puppet shows."
    ...
    "Gradually, Master Sylvian begins to dismantle the defensive walls he had erected, and Rory and I, in sync, follow suit. Hopefully, that's the right choice to make for now."
    ...
    $ zephyr_name = "Unknown"
    show lars
    Zephyr "Ahhh, keep quiet for a second! I'm not used to talking this much. If it weren't for you meddling Divs, I would have gotten away with my grandiose plan already."
    ...
    $ zephyr_name = "Unknown"
    show lars
    Zephyr "Hey, don't underestimate me. I could wipe your minds clean right now since you've already heard my voice, and even learnt of my grandiose plan —though not completely— and what else..."

    voice "audio/voice/zephyr/zephyr_023_take01.ogg"
    $ zephyr_name = "Unknown"
    show lars
    Zephyr "You're probably going to learn of my real name which is Zephyr, but anyway—"
    ...
    "We're spending too much time here; I need to take a proactive approach and ask him some questions myself before anything bad happens to everyone else who's been frozen."
...
label are_you_the_person:
    ...
    voice "audio/voice/claude/claude_109_take_02.ogg"
    show claude smile
    show lars serious
    ...
    voice "audio/voice/claude/claude_110_take_02.ogg"
    show claude serious
    show lars serious
    Claude "Shadowy figure, calls himself weird titles for attention, keeps talking about freezing time and brainwashing everyone. I think it's fairly obvious we have a deal-breaking villain on our hands."
    
    voice "audio/voice/claude/claude_110_take_03.ogg"
    show lars serious
    Claude "Unless...you're not actually the person behind this."
    ...
    voice "audio/voice/claude/claude_111_take_02.ogg"
    show claude smile
    show lars serious
    ...
    voice "audio/voice/claude/claude_112_take_03.ogg"
    show claude shocked
    show lars serious
    ...
    voice "audio/voice/claude/claude_113_take_03.ogg"
    show claude
    show lars serious
    ...
    show zephyr happy
    show lars serious
    Zephyr "Hold on there, bull woman, unless you want to be called Speedy or ah—"
...
label how_come_you:
    ...
    voice "audio/voice/claude/claude_114_take_03.ogg"
    show claude serious
    show lars serious
    Claude "But how could you? No money, no family, not even a proper place to sleep in, you- you'd be knee-deep in debt by this point if you decided to hire people."
    ...
    voice "audio/voice/claude/claude_116_take_01.ogg"
    show claude
    show lars serious
    Claude "Long story short, you just wanted free labor."

    voice "audio/voice/claude/claude_117_take_01.ogg"
    show lars serious
    Claude "We're past the stage of paying others with exposure and influencer points, you know?"

    voice "audio/voice/claude/claude_118_take_02.ogg"
    show claude smile with dissolve
    show claude smile at jp
    show lars serious
    ...
    show lars serious
    Sylvian "You keep mentioning your castle and innocently slaving away unknowing humans. But where is this castle of yours?"
    
    voice "audio/voice/sylvian/sylvian_073_take02.ogg"
    show lars serious
    Sylvian "None of my maps, scrolls, or academic documents have ever pointed to the existence of a secret and perished household like the one you're describing."
    ...
    show lars serious
    "He's right! We've been walking around this issue for some time now and haven't learnt one single coherent thing. Just bits and pieces that aren't helping us get out of this mess."
    ...
    "He definitely enjoys talking with people."
    ...
    show lars serious
    Lars "You woke up, broke, and homeless. You decided to use free labor from the descendants to clean up the mess in your castle. But, you couldn't pay them properly. Now you're slaving away unsuspecting humans who were ignorant about our realm."
    ...
    show lars serious
    Zephyr "Well, how could I bring them back to my castle without explaining the situation to them? They would get suspicious and run away from now. You know how hard I've worked to manually capture the humans and brainwash them to fix up my home?"
    
    voice "audio/voice/zephyr/zephyr_063_take02.ogg"
    show lars serious
    Zephyr "Or do you want me to be homeless?"

    voice "audio/voice/zephyr/zephyr_064_take02.ogg"
    show lars serious
    Zephyr "You heartless people, you're making me fake sob over here."
   
    voice "audio/voice/claude/claude_121_take_02.ogg"
    show lars serious
    Claude "You're obviously lacking a certain moral regard to be paying your employees so poorly, not to mention that—"
    ...
    show lars serious
    Zephyr "Rumor has it that news and gossip about transported humans fetch quite the price these days, rivaling even celebrities and renowned descendants."
    
    voice "audio/voice/zephyr/zephyr_068_take02.ogg"
    show lars serious
    Zephyr "If I could secure some scandalous scoops, I'd amass enough wealth to renovate my abode without the hassle of this extra business."
...
label G_1_End:
    ...
    "Master Sylvian beckons Rory over to his side and starts whispering something in her ear. I can't make out what they're saying, but it seems important enough that he even brings up his wings to cover his mouth."

    show rory at right with move

    "However, before I have more time to analyze what was going on, Rory chirps back to our side."

    show rory at right

    voice "audio/voice/rory/rory_039_take02.ogg"
    show lars
    Rory "You can't die on us yet {i}Ghostyyyy{/i}; I'm planning to give you a timeless puppet show after all!"
    ...
    voice "audio/voice/claude/claude_124_take_02.ogg"
    show lars
    ...
    "Good to know that we're demoted past the nicknames as well."
    ...
    "However, before Rory has the time to finish her sentence, Zephyr's shadow encloses around her, and they both disperse without a trace, leaving a momentary respite from his presence."
    ...
    show lars
    Claude "But he didn't even know that we have his so-called counter-artifact with us. Especially with how Captain [Lars] has been hiding the necklace under his clothing all this time."
    ...
    "A low murmur reaches me and I turn my gaze towards Master Sylvian. His expression has shifted into a stern, disapproving look. It's evident that Sir Claude's nonchalant attitude is grating on his nerves."

    "But then again, this has been Sir Claude's personality for a long time; there's no helping it."
    ...
    "His eyes lock onto mine, and a serene smile graces his lips."
    ...
    show lars
    Sylvian "After all, a person is not what they think they are, they are what they hide."

    "What they hide, huh? Zephyr already laid out their entire plan before us, so I can't quite decipher what the master is alluding to."
    ...
    "I glance down at the accessory that I've carefully concealed beneath my dragon pilot equipment, and my heart skips a beat when I see that it's still shining brightly with a vivid red glow."
    ...
    "The heat it emitted during our earlier encounter with Zephyr may have subsided, but its enchanting radiance remains."

    "Now that I think about it, he mentioned not knowing the whereabouts of the artifact, despite being in charge of the two couple necklaces all this time."
    
    "But the question is, why did this variable suddenly exempt us from the time freeze effect? Could it be related to the artifact?"
    ...
    show lars
    Sylvian "Perhaps... it's related to touching the artifact."

    show lars
    Sylvian "We all experienced this phenomenon after holding the necklace."

    Lars "Not to mention, we were the only people who touched the artifact after opening the box."

    hide shining_necklace with dissolve
    ...
    show lars
    Claude "Quite the detective, aren't you? I didn't realize I had a master of deduction by my side."
    ...
    Lars "I can't figure out why he's giving all this info to us either, knowing it's going to work against him. Does he have another plan in mind?"

    show claude smile at jp
    show lars
    Claude "Like Boss said, he's probably just a naive kid. But we can use that to our advantage."
    ...
    show lars
    Sylvian "He's more preoccupied with being entertained than trying to figure out why we're moving around freely. Do you recall him even questioning us about it?"

    Lars "Now that you mention it..."

    play music "track_5_zephyr_theme.ogg" fadeout 2.0 fadein 2.0

    "Speak of the devil, Zephyr's black particles coalesce once more and he and Rory appear side-by-side."
    
    "My initial worry dissipates as they emerge with grins plastered across their faces."
    ...
    show rory angry
    show lars
    Rory "Well, you're a few degrees short of cold-blooded, so I don't blame you, you fake—"
    ...
    "Master Sylvian's steady voice resonates with unwavering conviction as he moves forward to face Zephyr."
    ...
    "It seems like Master Sylvian will not be mentioning our displeasure about the brainwashed army at his castle. It's probably best to keep a secret for now."

    show lars serious
    Zephyr "Here's the fact, Smarty. I don't understand the mechanics of it either and I don't really have to."

    show lars serious
    Zephyr "What I do know is that you guys can escape the effects of my family heirloom either because you're special in some way or there's a variable that I'm not aware of..."

    "Oh no, is he catching on to our counter artifact?"

    "I grasp the gemstone beneath my piloting gear, my fingers wrapping around it tightly. It's as if I'm seeking reassurance that our hidden card remains securely in our possession"

    "Looking over my shoulder, I notice my tail wagging at full speed. The rhythmic swaying is almost involuntary, a physical manifestation of the heightened anxiety stirred by Zephyr's comments."
    ...
    "That's literally what we're trying to do here though!"
    ...
    show lars serious
    Zephyr "That won't do. I can't leave you guys alone; you might spoil my plans or decide to play around with the artifact when I'm not looking, especially since I gave you the description for it."
    
    show lars serious
    Zephyr "Got it, Scouty? Slicky? Smarty?"
    ...
    show lars serious
    Zephyr "Any who, how can you convince me that you won't be an obstacle to my plan until my castle is restored?"
    ...
    "This won't do! We must uncover the truth behind all of this."

    "I can't give up right now, not when I have a responsibility to protect my comrades."
    ...
    "He's definitely repaying us for listening to him."
    ...
    "Staying true to their personalities, both Master Sylvian and Sir Claude have their distinct motivations for wanting to unravel this mystery."

    "As for me, I'm still uncertain about my own stance. Who should I confide in to discuss my decision?"
...
label speak_with_Master_Sylvian:
    ...
    "Master Sylvian? What's with the sudden declaration? It almost sounded like..."
    ...
    with move
    "As I move away to speak with the other members, a faint whisper reaches me, though I can't discern its exact words."

    voice "audio/voice/sylvian/sylvian_087_take02.ogg"
    show lars
    Sylvian "{size=*0.85}It's been so long that I've reached out for a piece of my own accord that I've forgotten how to clench what's already in the palm of my hand."

    "I hope he didn't say anything too serious."
...
label speak_with_Sir_Claude:
    ...
    show claude smile at center_right with dissolve
    Lars "How do we present our case?"

    voice "audio/voice/claude/claude_125_take_02.ogg"
    show lars
    Claude "My dearest Captain [Lars], I adore your stubbornness at times like this, so it's only right that I offer my support."

    voice "audio/voice/claude/claude_126_take_01.ogg"
    show lars
    Claude "I believe it's wiser to pique our new Lord's interest in us rather than dismiss it."

    voice "audio/voice/claude/claude_127_take_02.ogg"
    show claude at shake
    show lars
    Claude "Picture this— he realizes we're ordinary individuals and decides to incorporate us into his team of {i}renovators{/i}."

    voice "audio/voice/claude/claude_128_take_01.ogg"
    show lars
    Claude "However, that would likely cut off our access to any information from the other members of this so-called army."

    voice "audio/voice/claude/claude_129_take_02.ogg"
    show lars
    Claude "That's why taking direct action is imperative."

    voice "audio/voice/claude/claude_130_take_02.ogg"
    show lars
    ...
    voice "audio/voice/claude/claude_131_take_02.ogg"
    show claude smile
    show lars
    ...
    voice "audio/voice/claude/claude_132_take_02.ogg"
    show claude blush
    show lars blush
    Claude "I would go on ahead on my own but I don't want to leave my duo behind either."

    voice "audio/voice/claude/claude_133_take_02.ogg"
    show lars blush
    Claude "It would be no fun without you by my side, [Lars]."

    "He called me [Lars]. I never thought I would hear him say my name in such a way."

    "I suppose it's only fitting that I match his level of enthusiasm."
    ...
    "Perhaps it was the surge of my newfound conviction or the palpable anticipation of an impending challenge that sent my adrenaline levels soaring."

    voice "audio/voice/claude/claude_134_take_01.ogg"
    show claude smile with dissolve
    show claude smile at jp
    show lars blush
    Claude "That's what I wanted to hear."

    voice "audio/voice/claude/claude_135_take_01.ogg"
    show lars blush
    Claude "Adventures favor the bold and fortunate."

    show lars blush
    "Alright, Alright, I get it. Time to get a move on now."

    voice "audio/voice/claude/claude_137_take_03.ogg"
    show lars
    ...
    show lars blush
    "What a riot, everyone else can hear you making such a loud declaration!"
    
    show lars blush
    "Not even a lick of embarrassment either, just how self-assured can someone be..."
...
label CS_6_End:
    ...
    show sylvian zorder 1 at center_1right
    ...
    "I stride purposefully towards him and hold my tail straight as a sign of readiness."
    ...
    "If he truly is as dangerous as we all think, then I should try to get to the root of this issue and make sure he doesn't use the time freeze artifact again."

    show lars serious
    Zephyr "Hurry up now, I don't have all day."

    show lars serious
    Lars "{size=*1.25}Lord Zephyr!" with vpunch
    ...
    "I share a meaningful look with my fellow guild members, and it's clear that they are all equally puzzled. The silence that follows my suggestion serves as confirmation."
    ...
    show lars
    Zephyr "Hmph, such insolence!" with vpunch
    ...
    show claude shocked at jp
    show sylvian at jp
    "Everyone" "{size=*1.5}WHAT????" with vpunch
    ...
    show lars serious
    Zephyr "I'll have two of you to take on the role of my personal  entertainers."
    ...
    "If he does go after the other guild members, he'll notice that we don't have any special powers to counteract the artifacts' time suspension effect."
    
    "We could all get caught without any counter measures! I don't want to risk going to an unknown location either."
    ...
    if options["CS6"]==1:
        ...
        "The intensity of Master Sylvian's gaze pins me, and my heart skips a beat in response. The heat in his stare seems to sear through me, and I can't help but feel the weight of his words hanging in the air."

        "I can't believe that I was this important to him."

        "Perhaps there's a chance to uncover more about him in the future."

        "Why he departed academia and how it caused him to abandon his past and establish the guild for us, alongside the rationale behind his motto of life to keep things uncomplicated and go with the flow."

        "Most importantly, I wonder why he wants me to be safe within his sight..."
    ...
    if options["CS6"]==2:
        ...
        "The intensity of Sir Claude's gaze pins me, and my heart skips a beat in response. The heat in his stare seems to sear through me, and I can't help but feel the weight of his words hanging in the air."

        "I can't believe that I was this important to him as his guild member."

        "Perhaps there's a chance to uncover more about him in the future."

        "His relationship with his family and his motivations for distancing himself from them, alongside the reason behind his affinity for challenges and ambition."

        "Most importantly, I wonder why he wants me as his partner in this venture..."

    
    "It looks like I'm stuck in a dilemma. Who will I choose?"

    hide rory angry
    hide sylvian serious funny
    hide claude blush
    hide zephyr
    with dissolve
