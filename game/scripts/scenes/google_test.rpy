...
label google_test_1:
    ...
    show claude shocked at center with moveinright
    $ gui.name_text_color = claude_color
    ...
    Lars "Bad at naming as always, Sir Claude. Especially for this fine species of {i}Spotted{/i} {i}Azureflame.{/i}"
