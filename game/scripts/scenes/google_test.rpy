...
label google_test_1:
    ...
    hide lars
    "MC" "Discere, cogitare, agere- the triad of wisdom."
    ...
    show claude at char_size, center with moveinright
    ...
    show lars at left with moveinleft
    show lars at left
    "MC" "It’s me Sir Claude. Did you already forget my name after a few hours of sleep?"

    call name_mc("Type your name in the textbox or press any button to go ahead with the standard name ‘Lars’.")
    ...
    hide lars
    Lars "Sir Claude, the bold merchant and adventurer, never shied away from making audacious statements. It was a quality of his that I admired and sought to learn from. His boundless ambition was a driving force, especially in a world teeming with dragon trainers, companions, and pilots."
    ...
    show claude at char_size, right with moveinright
    hide lars
