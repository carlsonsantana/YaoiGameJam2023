...
label google_test_8:
    ...
    show lars  at left
    "Sylvian" "U-uhm…E-Exactly, we put on puppet shows for a living. I’m sure my junior and ou puppet master over here will be able to explain it in detail for you."
    ...
    "Rory" "That’s the most you can get form us."
...
label selection_9_1:
    ...
    "Sylvian" "He basically admitted to slaving away humas and descendants alike just to have the previous person withholding our artifact to return."
...
label google_test_9:
    ...
    hide lars
    Lars "If he does go after the other two, he’ll notice that we they don’t have any special powers to counteract the artifacts time suspension affect. We could all get caught!"
    ...
    "Sylvian" "I’d lose a piece in my heart where I can find solace and peace."
    ...
    menu:
        ...
        "Claude":
            $ selection_10_answer = 1
            jump selection_10_1
            return

        "Sylvian":
            $ selection_10_answer = 2
            jump selection_10_2
            return

    return

label selection_10_1:

    jump google_test_10

    return

label selection_10_2:

    jump google_test_10

    return

label google_test_10:
