...
label test_script:
    ...
    with vpunch
    Lars "*Discere, cogitare, agere*- {sc=5}the triad of wisdom{/sc}. Learning enriches the mind, and thinking sharpens it, but it is through action that we truly manifest our knowledge and shape our reality."

    Lars "You would think that a merchant guild wouldn’t bother creating such a philosophical motto and instead advertise 1+1 dragon ship seats every holiday season."

    Lars "We could even offer complementary earth meals from the reincarnated human chefs who arrived to the realm of Zephyr, but I have a feeling that *one particular guild member* of “Custodes Sylvae,” would end up devouring all the dishes before the passengers even get to set their eyes on them."
